function switchCheck(newPieceBoard: string[][], currentColumn: number, currentRow: number, activeColor: string, activePiece: string){
    switch(activePiece){
        case 'p':
            newPieceBoard = pawnCheck(newPieceBoard, currentColumn, currentRow, activeColor);
            break;

        case 'b':
            newPieceBoard = bishopCheck(newPieceBoard, currentColumn, currentRow, activeColor);
            break;
        
        case 'r':
            newPieceBoard = rookCheck(newPieceBoard, currentColumn, currentRow, activeColor);
            break;

        case 'q':
            newPieceBoard = queenCheck(newPieceBoard, currentColumn, currentRow, activeColor);
            break;

        case 'k':
            newPieceBoard = kingCheck(newPieceBoard, currentColumn, currentRow, activeColor);
            break;

        case 'n':
            newPieceBoard = knightCheck(newPieceBoard, currentColumn, currentRow, activeColor);
            break;
...
function pawnCheck(newPieceBoard: string[][], currentColumn: number, currentRow: number, activeColor: string){
...
function bishopCheck(newPieceBoard: string[][], currentColumn: number, currentRow: number, activeColor: string){
...
function rookCheck(newPieceBoard: string[][], currentColumn: number, currentRow: number, activeColor: string){
    //right side check
...
//add letter variable to the checks, first add Bs then As
...
function knightCheck(newPieceBoard: string[][], currentColumn: number, currentRow: number, activeColor: string){
